...
def run_design_check(
    ...
    design_results = {
        ...
        KEY_SD_TS_V                : (capacity.details.get("stud_spacing") or {}).get("V_kN"),
        KEY_SD_TS_AEC              : (capacity.details.get("stud_spacing") or {}).get("Aec_mm2"),
        KEY_SD_TS_Y                : (capacity.details.get("stud_spacing") or {}).get("Y_mm"),
        KEY_SD_TS_IC               : (capacity.details.get("stud_spacing") or {}).get("Ic_mm4"),
        KEY_SD_TS_TEFF             : (capacity.details.get("stud_spacing") or {}).get("t_eff_mm"),
        KEY_SD_TS_BEFF             : (capacity.details.get("stud_spacing") or {}).get("beff_mm"),
        KEY_SD_TS_XU               : (capacity.details.get("stud_spacing") or {}).get("xu_mm"),
        KEY_SD_TS_TSLAB            :  (capacity.details.get("stud_spacing") or {}).get("t_slab_mm"),
        # -- crack control --
